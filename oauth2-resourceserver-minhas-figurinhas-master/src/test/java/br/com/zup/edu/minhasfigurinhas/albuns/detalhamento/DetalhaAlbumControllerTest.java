...
class DetalhaAlbumControllerTest extends SpringBootIntegrationTest {
    ...
    public void deveDetalharAlbumComSuasFigurinhas() throws Exception {
        ...
        mockMvc.perform(GET("/api/albuns/{id}", album.getId())
                        .with(jwt()
                                .authorities(new SimpleGrantedAuthority("SCOPE_minhas-figurinhas:read"))
                        ))
    ...
    @Test
    public void naoDeveDetalharAlbumComSuasFigurinhasSemToken() throws Exception {
        // cenario
        Album album = new Album("DBZ", "Album do DBZ", "rafael.ponte");
        album.adiciona(
                new Figurinha("goku", "http://animes.com/dbz/goku.jpg"),
    ...
    @Test
    public void naoDeveDetalharAlbumComSuasFigurinhasSemEscope() throws Exception {
        // cenario
        Album album = new Album("DBZ", "Album do DBZ", "rafael.ponte");
        album.adiciona(
                new Figurinha("goku", "http://animes.com/dbz/goku.jpg"),
